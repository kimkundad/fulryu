          ...
          <div class="row">
                        ...
                        <div class="col-md-8 col-lg-8">
                              ...
                              <form  method="POST" action="{{$url}}" enctype="multipart/form-data">
                                  ...
                                  <div class="form-group">
          													<label class="col-md-3 control-label" for="profileFirstName">ราคา ซื้อสินค้าครบ*</label>
          													<div class="col-md-8">
          														<input type="text" class="form-control" name="c_price_product" value="{{$objs->c_price_product}}">
          														</div>
          												</div>
                                  <br>
