                        ...
                        <div class="col-md-8 col-lg-8">
                              ...
                              <form  method="POST" action="{{$url}}" enctype="multipart/form-data">
                                  ...
                                  <div class="form-group">
          													...
          													<div class="col-md-8">
          														<input type="text" class="form-control" name="text_1" value="{{ $objs->text_slide1}}" placeholder="living room">
          														</div>
          												</div>
                                  ...
                                  <div class="form-group">
          													...
          													<div class="col-md-8">
          														<input type="text" class="form-control" name="text_2" value="{{ $objs->text_slide2}}" placeholder="REST CUSHION">
          														</div>
          												</div>
                                  ...
                                  <div class="form-group">
          													...
          													<div class="col-md-8">
                                      <textarea name="text_3" class="form-control" placeholder="The design of the Rest fabric began from the use of leftover materials..">{{ $objs->text_slide3}}</textarea>
