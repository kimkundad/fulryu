            ...
            <section class="panel">
              ...
              <div class="panel-body">
                ...
                <div class="col-md-12 " style="padding-left: 1px;">
                  ...
                  <a class="btn btn-primary " href="{{url('admin/blog/create')}}" >
             ...
             @if($objs)
                @foreach($objs as $u)
                    <tr id="{{$u->id}}">
                      <td>{{mb_substr($u->blog_title,0,40,'UTF-8')}}..</td>
                      <td>{{$u->option}}</td>
                      ...
                      <td>
                        ...
                        <div class="btn-group flex-wrap">
  												...
  												<div class="dropdown-menu" role="menu">
  													...
  													<a class="dropdown-item text-1" href="{{url('admin/blog/'.$u->id.'/edit')}}">แก้ไข</a>
